...
internal class LineChart : Control
{
	...
	private static (PathGeometry Stroke, PathGeometry Fill, Geometry HorizontalGridLines, Geometry VerticalGridLines, Geometry MinMaxLines) GenerateCurves(ITimeSeries series, double minValue, double maxValue, double outputWidth, double outputHeight)
	{
